(() => {
  ...
  // src/buttonHover.js
  var require_buttonHover = __commonJS({
    "src/buttonHover.js"(exports) {
      init_gsap();
      exports.buttonHoverInteraction = function() {
        gsapWithCSS.set("[button-clip-wrapper]", {
          xPercent: -50,
          yPercent: -50,
          scale: 0,
          opacity: 0
        ...
        function moveAndScale(button, buttonClip) {
          ...
          let xTo = gsapWithCSS.quickTo(buttonClip, "x", { duration: 0.1, ease: "power3" });
          let yTo = gsapWithCSS.quickTo(buttonClip, "y", { duration: 0.1, ease: "power3" });
          ...
          button.addEventListener("mouseenter", () => {
            ...
            let tl = gsapWithCSS.timeline().to(buttonClip, { scale: percentIncrease + 1, duration: 0.5 }).to(buttonClip, { opacity: 1, duration: 0 }, 0);
          });
          button.addEventListener("mouseleave", () => {
            let tl = gsapWithCSS.timeline().to(buttonClip, { scale: 0, duration: 0.3 }).to(buttonClip, { opacity: 0, duration: 0 });
  ...
  // src/second-fold.js
  var require_second_fold = __commonJS({
    "src/second-fold.js"(exports) {
      init_gsap();
      init_ScrollTrigger();
      ...
      exports.secondFoldIx = () => {
        ...
        const svgTl = gsapWithCSS.timeline({
          defaults: { duration: 0.5, ease: "power2.out" }
        });
        svgTl.from(middlePath, { strokeDashoffset: -middlePathLength }).from(leftBottomPath, { strokeDashoffset: -leftBottomPathLength }, "<60%").from(rightBottomPath, { strokeDashoffset: -rightBottomPathLength }, "<").from(leftCurve1, { strokeDashoffset: -leftCurve1Length }).from(rightCurve1, { strokeDashoffset: -rightCurve1Length }, "<").from(leftCurve3, { strokeDashoffset: -leftCurve3Length }).from(rightCurve3, { strokeDashoffset: -rightCurve3Length }, "<").from(leftCurve2, { strokeDashoffset: -leftCurve2Length }).from(rightCurve2, { strokeDashoffset: -rightCurve2Length }, "<");
        secondFoldTl.from(".cert_content_title .line", {
          opacity: 0,
          y: -20,
          stagger: { amount: 0.3 }
        }).from(
    ...
    "src/rocket.js"(exports) {
      ...
      exports.rocketIx = () => {
        ...
        rocketTriggers.forEach((rocketTrigger) => {
          ...
          const rocketTl = gsapWithCSS.timeline({
            scrollTrigger: {
  ...
  // src/fourth-fold.js
  var require_fourth_fold = __commonJS({
    "src/fourth-fold.js"(exports) {
      init_gsap();
      init_ScrollTrigger();
      gsapWithCSS.registerPlugin(ScrollTrigger2);
      exports.fourthFoldIx = () => {
        const fourthFoldTl = gsapWithCSS.timeline({
          scrollTrigger: {
            trigger: ".section_benchmark",
            start: "top 60%"
          }
        });
        fourthFoldTl.from(".benchmark-left h2", { opacity: 0, y: -20, duration: 0.5 }).from(
          ".benchmark-left .line",
          {
            opacity: 0,
            y: -20,
  ...
  // src/form-svg.js
  var require_form_svg = __commonJS({
    "src/form-svg.js"(exports) {
      init_gsap();
      init_ScrollTrigger();
      gsapWithCSS.registerPlugin(ScrollTrigger2);
      exports.formSvgIx = () => {
        const formSvgTl = gsapWithCSS.timeline({
          scrollTrigger: {
        ...
        const formContentTl = gsapWithCSS.timeline({
          scrollTrigger: {
            trigger: ".form_col-1",
            start: "top 75%",
            end: "bottom 100%",
  ...
  // src/section-cert.js
  var require_section_cert = __commonJS({
    "src/section-cert.js"(exports) {
      init_gsap();
      init_ScrollTrigger();
      gsapWithCSS.registerPlugin(ScrollTrigger2);
      exports.sectionCertIx = () => {
        const sectionCertTl = gsapWithCSS.timeline({
          scrollTrigger: {
        ...
        sectionCertTl.from(".section_cert-logos h2", { opacity: 0, y: 40, duration: 1.25 }).from(
  ...
  // src/section-step.js
  var require_section_step = __commonJS({
    "src/section-step.js"(exports) {
      init_gsap();
      init_ScrollTrigger();
      gsapWithCSS.registerPlugin(ScrollTrigger2);
      exports.sectionStepsIx = () => {
        const sectionStepsTl = gsapWithCSS.timeline({
          scrollTrigger: {
            trigger: ".steps-wrapper",
            start: "top 60%"
          }
        });
        sectionStepsTl.from(".steps-title h2 .line", {
          opacity: 0,
          y: -20,
          stagger: { amount: 0.5 }
        }).from(
  ...
  // src/index.js
  var import_buttonHover = __toESM(require_buttonHover());
  var import_second_fold = __toESM(require_second_fold());
  var import_rocket = __toESM(require_rocket());
  var import_fourth_fold = __toESM(require_fourth_fold());
  var import_form_svg = __toESM(require_form_svg());
  var import_section_cert = __toESM(require_section_cert());
  var import_section_step = __toESM(require_section_step());
  ...
  window.addEventListener("DOMContentLoaded", (event) => {
    ...
    if (window.innerWidth > 991) {
      (0, import_buttonHover.buttonHoverInteraction)();
    }
    (0, import_second_fold.secondFoldIx)();
    (0, import_rocket.rocketIx)();
    (0, import_fourth_fold.fourthFoldIx)();
    (0, import_form_svg.formSvgIx)();
    (0, import_section_cert.sectionCertIx)();
    (0, import_section_step.sectionStepsIx)();
  });
})();
